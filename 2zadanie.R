#Мельниченко Екатерина Даниловна — создайте модель 
#множественной линейной регрессии дневных потоков углекислого 
#газа за весенний период 2013 года по данным измерений 
